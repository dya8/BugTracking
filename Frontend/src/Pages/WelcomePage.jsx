...
const WelcomePage = () => {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-purple-400 to-purple-700 text-white text-center px-4">
      {/* Title */}
      <h1 className="text-4xl md:text-5xl text-white font-bold">Welcome to <br /> Bug Tracker!</h1>
      ...
      {/* Button */}
      <button className="mt-6 px-6 py-3 bg-purple-900 hover:bg-purple-800 text-white text-lg font-semibold rounded-lg shadow-md transition">
        Let’s Go!
      </button>
